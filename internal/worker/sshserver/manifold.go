...
// GetControllerSSHHostKeyService gets the controller SSH host key service.
...
// GetDomainServicesGetter gets the model domain service factory.
...
// GetSSHService gets the model-scoped SSH service.
...
// ManifoldConfig configures the controller SSH server worker.
...
// Manifold returns a manifold that runs an embedded SSH server.
